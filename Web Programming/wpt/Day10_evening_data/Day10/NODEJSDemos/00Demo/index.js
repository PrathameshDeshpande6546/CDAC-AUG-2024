...
var helper =  http.createServer((request, response)=>{
    ...
    if(request.url == "/api/users")
    {
        ...
        response.setHeader("Content-Type", "application/json");//tells client about the type of data
        response.write(JSON.stringify(users)); //stringify converts json type of data to object;
